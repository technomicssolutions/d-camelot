...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ShopInventory', fields ['item']
        db.delete_unique(u'inventory_shopinventory', ['item_id'])

        # Adding unique constraint on 'ShopInventory', fields ['shop', 'item']
        db.create_unique(u'inventory_shopinventory', ['shop_id', 'item_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'ShopInventory', fields ['shop', 'item']
        db.delete_unique(u'inventory_shopinventory', ['shop_id', 'item_id'])

        # Adding unique constraint on 'ShopInventory', fields ['item']
        db.create_unique(u'inventory_shopinventory', ['item_id'])
