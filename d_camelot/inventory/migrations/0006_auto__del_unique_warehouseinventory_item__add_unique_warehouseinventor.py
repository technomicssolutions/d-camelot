...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'WarehouseInventory', fields ['item']
        db.delete_unique(u'inventory_warehouseinventory', ['item_id'])

        # Adding unique constraint on 'WarehouseInventory', fields ['warehouse', 'item']
        db.create_unique(u'inventory_warehouseinventory', ['warehouse_id', 'item_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'WarehouseInventory', fields ['warehouse', 'item']
        db.delete_unique(u'inventory_warehouseinventory', ['warehouse_id', 'item_id'])

        # Adding unique constraint on 'WarehouseInventory', fields ['item']
        db.create_unique(u'inventory_warehouseinventory', ['item_id'])
