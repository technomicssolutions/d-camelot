...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CustomCategory', fields ['name', 'parent']
        db.create_unique(u'inventory_customcategory', ['name', 'parent_id'])

        # Adding field 'Item.image'
        db.add_column(u'inventory_item', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'CustomCategory', fields ['name', 'parent']
        db.delete_unique(u'inventory_customcategory', ['name', 'parent_id'])

        # Deleting field 'Item.image'
        db.delete_column(u'inventory_item', 'image')
    ...
    models = {
        ...
        u'inventory.customcategory': {
            'Meta': {'ordering': "('tree_id', 'lft')", 'unique_together': "(('parent', 'name'),)", 'object_name': 'CustomCategory'},
